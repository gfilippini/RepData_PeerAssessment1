...
## makes the plot
ggplot(activityNew, aes(date, steps)) + geom_bar(stat = "identity", colour = "darkgreen" , fill = "darkgreen", width = 0.7) + facet_grid(. ~ month, scales = "free") + labs(title = "4.Histogram of Total Number of Steps Taken Each Day", x = "Date", y = "Number of steps")
```
